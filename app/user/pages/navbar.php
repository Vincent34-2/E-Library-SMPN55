<header class="main-header">
    ...
    <!-- Logo -->
    <a href="dashboard" class="logo" style="font-family:  sans-serif; position: fixed">
        <!-- mini logo for sidebar mini 50x50 pixels -->
        <span class="logo-mini"><b>55 DKI</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="font-weight-bold"><strong><h4>PERPUSTAKAAN 55 Jakarta Utara</h4></strong></span>
    </a>
    
    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top" style="position: fixed; top: 0; width: 100%; z-index: 1000;">
            ...
            <ul class="nav navbar-nav"style="margin-right: 50px">
                                ...
                                ?>
                                    <li>
                                        ...
                                        <a href="lihat-pesan?id_pesan=<?= $row_pesan1['id_pesan']; ?>">
                                            <div class="pull-left">
                                                <img src="../../assets/dist/img/naura.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                <?php
                                                include "../../config/koneksi.php";
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="../../assets/dist/img/naura.jpg" class="user-image" alt="User Image">
