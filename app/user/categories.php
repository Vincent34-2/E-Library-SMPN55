...
// Query untuk mendapatkan daftar kategori buku
...
<body>
    ...
    <div class="container">
        <?php foreach ($categories as $category): ?>
            <?php
            // Menentukan kelas tombol berdasarkan ID kategori atau nama kategori
            switch ($category['id']) {
                case 1:
                    $buttonClass = 'button--piyo';
                    break;
                case 2:
                    $buttonClass = 'button--hoo';
                    break;
                case 3:
                    $buttonClass = 'button--pen';
                    break;
                default:
                    $buttonClass = 'button--pen';
                    break;
            ...
            ?>
            <a href="books_by_category.php?category_id=<?= htmlspecialchars($category['id']) ?>" class="button <?= $buttonClass ?>">
