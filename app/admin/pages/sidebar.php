        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="anggota"></i> Data Anggota</a></li>
                    <li><a href="penerbit"></i> Data Penerbit</a></li>
                    <li><a href="administrator"></i> Administrator</a></li>
                    <li><a href="data-peminjaman"></i> Data Peminjaman</a></li>
                    <li><a href="data-pengembalian"></i> Data Pengembalian</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
                ...
                <ul class="treeview-menu">
                    <li><a href="data-buku"></i> Data Buku</a></li>
                    <li><a href="kategori-buku"></i> Kategori Buku</a></li>
                </ul>
            </li>
           <!-- eBook Management Menu -->
<li class="dropdown">
    <a href="upload_ebook.php" class="dropdown-toggle">
        <i class="fa fa-upload"></i> Add eBook
    </a>
</li>
<li class="dropdown">
    <a href="list_ebooks.php" class="dropdown-toggle">
        <i class="fa fa-book"></i> List eBooks
    </a>
</li>
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="border-radius: 5px;">
            <div class="modal-header">
                ...
                <h4 class="modal-title" style="font-family: sans-serif; font-weight: bold;">Peringatan</h4>
            </div>
            ...
            <div class="modal-footer">
                ...
                <a href="keluar" class="btn btn-primary">Ya</a>
            </div>
        </div>
    </div>
</div>
