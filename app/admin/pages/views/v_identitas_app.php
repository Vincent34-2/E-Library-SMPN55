    ...
    <section class="content">
        <div class="row">
            <div class="col-md-8">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title" style="font-family:   sans-serif; font-weight: bold;">Edit Identitas  Aplikasi</h3>
                    </div>
                    <!-- /.box-header -->
            ...
            <div class="col-md-4">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title" style="font-family:   sans-serif; font-weight: bold;">Identitas  Aplikasi</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <img src="../../assets/dist/img/smp55.png" style="width: 125px; height: 125px; display: block; margin-left: auto; margin-right: auto; margin-top: -10px; margin-bottom: 15px;">
                        <!-- Animasi -->
