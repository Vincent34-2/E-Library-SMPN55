...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="alert alert-secondary" style="color: #383d41; background-color: #e2e3e5; border-color: #d6d8db;">
            Selamat Datang, <?= $_SESSION['fullname']; ?> di Perpustakaan SMPN 55 Jakarta.
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <?php
                include "../../config/koneksi.php";
                $query_pengembalian = mysqli_query($koneksi, "SELECT * FROM pengembalian WHERE tanggal_pengembalian > 0");
        ...
        <div class="row">
            ...
            <img src="../../assets/dist/img/smp55.png" width="120px" height="120px" style="display: block; margin-left: auto; margin-right: auto; margin-top: 30px; margin-bottom: 20px;">

            <h2 class="text-center" style="font-weight-bold: sans-serif, bold;"><strong>Perpustakaan SMPN 55 Jakarta</strong></h2>
            <p class="text-center">Alamat : Jl. Bahari A. 11, RT.06/03, Tj. Priok, Kec. Tj. Priok, Jakarta Utara, Daerah Khusus Ibukota Jakarta 14310</p>
