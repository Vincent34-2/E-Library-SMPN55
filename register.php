...
<body class="hold-transition login-page" style="font-family:   sans-serif;">
    <div class="login-box">
        <div class="login-logo">
        <p class="font-weight-bold"><strong><h1>PERPUSTAKAAN  SMPN 55 JAKARTA</h1></strong></p>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body" style="border-radius: 10px;">
            <img src="assets/dist/img/smp55.png" height="80px" width="80px" style="display: block; margin-left: auto; margin-right: auto; margin-top: -12px; margin-bottom: 5px;">
